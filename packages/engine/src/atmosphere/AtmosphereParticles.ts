...
import type { VisualIdentity, AtmosphereParticleType } from '../terrain/types'
...
export class AtmosphereParticles {
  ...
  update(dt: number, playerPos: THREE.Vector3, camera: THREE.Camera, visual: VisualIdentity) {
    this.elapsed += dt
