...
export const ashWastesBiome: BiomeConfig = {
  ...
  skyConfig: {
    zenithDay: new THREE.Color(0x181818),
    zenithNight: new THREE.Color(0x060606),
    horizonDay: new THREE.Color(0x303028),
    horizonNight: new THREE.Color(0x0a0a08),
    cloudColor: new THREE.Color(0x282820),
    cloudDensity: 0.15,
    hazeStrength: 0.7,
  },
  ...
  spriteTypes: [
    { category: 'tree',      weight: 4, minScale: 4, maxScale: 9,   isBillboard: true },
    { category: 'rock',      weight: 5, minScale: 1, maxScale: 3,   isBillboard: false },
    { category: 'structure', weight: 1.0, minScale: 3, maxScale: 6, isBillboard: true },
