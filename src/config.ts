...
export const TERRAIN_CONFIG = {
  ...
  enableAlpineRocks: true,
  enableAlpineCabins: true,
  enableCliffLedges: true,
  enableCliffNests: true,
  enableFloatingRocks: true,
  enableSkyBridges: true,
  enableJungleCanopy: true,
  enableJungleRuins: true,
  enableMesaPillars: true,
  enableMesaDwellings: true,
  enableCoralFormations: true,
  enableReefCaves: true,
  enableBogMounds: true,
  enableBogBridges: true,
  enableBadlandsHoodoos: true,
  enableBadlandsArches: true,
  enableTaigaLogs: true,
