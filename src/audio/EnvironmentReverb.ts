...
const BIOME_TO_PROFILE: Record<BiomeType, string> = {
  ...
  [BiomeType.Mushroom]:        'cave',
  [BiomeType.Desert]:          'desert',
  [BiomeType.Badlands]:        'desert',
  ...
  [BiomeType.AshWastes]:       'infernal',
  [BiomeType.Snow]:            'snow',
  [BiomeType.Tundra]:          'snow',
  [BiomeType.Alpine]:          'snow',
  [BiomeType.Heaven]:          'ethereal',
  [BiomeType.FloatingIslands]: 'ethereal',
  [BiomeType.Savanna]:         'savanna',
  [BiomeType.Oasis]:           'savanna',
  [BiomeType.Cliffs]:          'cliffs',
}
