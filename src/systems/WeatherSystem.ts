...
const BIOME_WEATHER: Partial<Record<BiomeType, WeatherEntry[]>> = {
  ...
  [BiomeType.Desert]:          [[WeatherType.Clear,6],[WeatherType.Sandstorm,2]],
  [BiomeType.Volcanic]:        [[WeatherType.Clear,3],[WeatherType.AshFall,4]],
  [BiomeType.Snow]:            [[WeatherType.Clear,4],[WeatherType.Snow,3],[WeatherType.Blizzard,1]],
  [BiomeType.Alpine]:          [[WeatherType.Clear,4],[WeatherType.Snow,3],[WeatherType.Blizzard,1]],
  [BiomeType.Tundra]:          [[WeatherType.Clear,4],[WeatherType.Snow,3],[WeatherType.Blizzard,1]],
  [BiomeType.Taiga]:           [[WeatherType.Clear,4],[WeatherType.Snow,3],[WeatherType.Blizzard,1]],
  [BiomeType.Swamp]:           [[WeatherType.Clear,2],[WeatherType.Rain,3],[WeatherType.Fog,4]],
  [BiomeType.Bog]:             [[WeatherType.Clear,2],[WeatherType.Rain,3],[WeatherType.Fog,4]],
  ...
  [BiomeType.Badlands]:        [[WeatherType.Clear,5],[WeatherType.Sandstorm,2],[WeatherType.Fog,1]],
  [BiomeType.CoralReef]:       [[WeatherType.Clear,4],[WeatherType.Rain,2]],
  [BiomeType.FloatingIslands]: [[WeatherType.Clear,4],[WeatherType.Fog,2],[WeatherType.Rain,2]],
  [BiomeType.Cliffs]:          [[WeatherType.Clear,4],[WeatherType.Fog,2],[WeatherType.Rain,2]],
  [BiomeType.Oasis]:           [[WeatherType.Clear,6],[WeatherType.Rain,1],[WeatherType.Sandstorm,1]],
  [BiomeType.Savanna]:         [[WeatherType.Clear,6],[WeatherType.Rain,1],[WeatherType.Sandstorm,1]],
  [BiomeType.Heaven]:          [[WeatherType.Clear,10]],
  [BiomeType.Hell]:            [[WeatherType.AshFall,10]],
  [BiomeType.Crystal]:         [[WeatherType.Clear,5],[WeatherType.Fog,3]],
  [BiomeType.Mushroom]:        [[WeatherType.Clear,5],[WeatherType.Fog,3]],
  [BiomeType.AshWastes]:       [[WeatherType.Clear,3],[WeatherType.AshFall,5]],
}
